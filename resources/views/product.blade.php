            ...
            <div class="product-one">
                ...
                <div class="content">
                    ...
                    <div class="flex justify-center items-center">
                        ...
                        <button type="submit" class="flex ml-auto text-white font-medium bg-green-500 border-0 py-6 px-12 focus:outline-none hover:bg-green-600 rounded">В корзину</button>
